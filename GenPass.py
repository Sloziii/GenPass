...
def actions(string):
  if(string == 'home'):
    ...
    password_name = input(Colors.red + 'Give the name of the password to remove --> ')
    try:
      existing_file = open(password_name + '.txt')
      existing_file.close
      confirmation = input(Colors.red + 'Are you sure that you want to definitely remove your password file for ' + password_name + ' ? (y/N) --> ')
    ...
    password_name = input(Colors.red + 'Give the name of the password to change --> ')

    try:
      existing_file = open(password_name + '.txt')
      existing_file.close()
      confirmation = input(Colors.red + 'Are you sure that you want to change the password for ' + password_name + ' ? (y/N) --> ')
      confirmation_possibilities = ['y', 'N']
      if (confirmation_possibilities.__contains__(confirmation)):
        if (confirmation == "y"):
          try:
